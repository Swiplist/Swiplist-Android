...
class ProfileEditFriendActivity : AppCompatActivity(), AdapterView.OnItemClickListener,
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_profile_edit_friend)
        initData()
        initMenu()
        initUiAndListener()
    ...
    private fun initUiAndListener() {
        mListView = findViewById(R.id.profile_edit_friend)
    ...
    private val mAdapter = object : BaseAdapter() {
        ...
        override fun getView(position: Int, convertView: View?, parent: ViewGroup): View {
            ...
            if (listCellView == null) {
                ...
                listCellView = LayoutInflater.from(this@ProfileEditFriendActivity).inflate(R.layout.friend_custom_btn, null)
                cvh.imgLogo = listCellView.findViewById(R.id.img_friend_edit) as ImageView
                cvh.txtName = listCellView.findViewById(R.id.txt_friend_edit) as TextView
                cvh.imgLogo2 = listCellView.findViewById(R.id.img_friend_edit2) as ImageView
